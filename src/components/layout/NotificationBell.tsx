...
import { Bell, Check, Loader2, MessageSquare, CreditCard, BookOpen, Settings, ExternalLink, BadgeCheck } from 'lucide-react';
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-end gap-2">
                        {isCourseStatus && (
                          <span className="inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2 py-1 text-[10px] font-semibold text-emerald-700 border border-emerald-100">
