  ...
  return (
    <div className="p-10 max-w-6xl mx-auto space-y-10">
      ...
      <div className="border border-slate-200 rounded-md overflow-hidden shadow-sm">
        ...
        <div className="p-8 bg-[#1a1c1e] text-white relative overflow-hidden group border-t border-white/5">
           ...
           <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
              ...
              <div className="flex flex-col items-center lg:items-end gap-3 shrink-0">
                 <Button 
                   disabled={true}
                   className="font-black text-xs uppercase tracking-widest px-10 py-7 bg-white/10 text-white/30 border border-white/10 cursor-not-allowed"
                 >
                    {t('coming_soon')}...
                 </Button>
